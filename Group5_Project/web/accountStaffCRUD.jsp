...
<html lang="en">
    ...
    <body>
            ...
            <div id="content">
                        ...
                        <div class="row"> 
                            ...
                            <div class="col-md-5 col-lg-3 order-3 order-md-2">
                                <div class="xp-searchbar">
                                    <form action="accountstaff" method="get">
                ...
                <div class="main-content">
                    ...
                    <div class="row" id="tableStaffAccount">
                        <div id="" class="col-md-12">
                            <div id="customertable" class="table-wrapper">
                                <div class="table-title">
                                    <div class="row">
                                        <div class="col-sm-6 p-0 d-flex justify-content-lg-start justify-content-center">
                                            <h2 class="ml-lg-2">Account Employees</h2>
                                        </div>
                                                    ...
                                                    <ul class="dropdown-menu custom2-dropdown1">
                                                        <li class="nav-item submenu dropdown custom2-dropdown2">
                                                            ...
                                                            <ul class=" custom2-dropdown3">
                                                                <li class="nav-item">
                                                                    <a class="nav-link" href="accountstaff?sortby=Username&orderSort=asc&searchAccount=${not empty searchAccount?searchAccount:''}">Username</a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a class="nav-link" href="accountstaff?sortby=CreatedAt&orderSort=asc&searchAccount=${not empty searchAccount?searchAccount:''}">CreatedAt</a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                        <li class="nav-item submenu dropdown custom2-dropdown2">
                                                            ...
                                                            <ul class=" custom2-dropdown3">
                                                                <li class="nav-item">
                                                                    <a class="nav-link" href="accountstaff?sortby=Username&orderSort=desc&searchAccount=${not empty searchAccount?searchAccount:''}">Username</a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a class="nav-link" href="accountstaff?sortby=CreatedAt&orderSort=desc&searchAccount=${not empty searchAccount?searchAccount:''}">CreatedAt</a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                    </ul>
                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                        <c:forEach items="${listPageAcc}" var="acc1">
                                            <tr>
                                                <td>
                                                    <span class="custom-checkbox">
                                                ...
                                                <td>${acc1.staff.phone}</td>
                                                <td>${acc1.staff.email}</td>
                                                <td style="white-space: nowrap;">${acc1.role}</td>
                                                <td style="white-space: nowrap; font-size: 14px">${acc1.createAt}</td>
                                                <td>
                                                    <a href="#editEmployeeModal" class="edit" data-toggle="modal"
                                                       onclick="staffFrom('${acc1.accountID}', '${acc1.username}', '${acc1.password}', '${acc1.role}', '${acc1.staff.staffID}');return false;">
                                                        <i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                                    <a href="#" class="delete" data-toggle="modal" data-target="#deleteEmployeeModal" data-id="${acc1.accountID}">
                                                        <i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                                </td> 
                                                <td>
                                                    <a href="#profileEmployeeModal" class="btn btn-success" style="color: #f8f9fa; font-size: 14px" data-toggle="modal"
                                                       onclick="staffFromProfile('${acc1.staff.staffID}', '${acc1.staff.firstName}', '${acc1.staff.lastName}', '${acc1.staff.position}',
                                                                       '${acc1.staff.salary}', '${acc1.staff.dateOfBirth}', '${acc1.staff.address}',
                                                                       '${acc1.staff.city}', '${acc1.staff.country}', '${acc1.staff.phone}', '${acc1.staff.email}', '${acc1.staff.hireDate}'
                                                                       );
                                                               return false;">
                                                        <span>Show</span></a>
                                                </td>
                                ...
                                <div class="clearfix">
                                    ...
                                    <ul class="pagination">
                                        <c:if test="${tag > 1}">
                                            <li class="page-item disabled"><a href="accountstaff?sortby=${not empty sortby?sortby:'default'}&orderSort=${not empty orderSort?orderSort:'default'}&index=${tag - 1}&searchAccount=${not empty searchAccount?searchAccount:''}">Previous</a></li>
                                            </c:if>
                                            <c:forEach begin="1" end="${endPage}" var="i">
                                            <li class="page-item  ${tag == i?"active":""}"><a href="accountstaff?sortby=${not empty sortby?sortby:'default'}&orderSort=${not empty orderSort?orderSort:'default'}&index=${i}&searchAccount=${not empty searchAccount?searchAccount:''}" class="page-link">${i}</a></li>
                                            </c:forEach>
                                            <c:if test="${tag < endPage}">
                                            <li class="page-item"><a href="accountstaff?sortby=${not empty sortby?sortby:'default'}&orderSort=${not empty orderSort?orderSort:'default'}&index=${tag + 1}&searchAccount=${not empty searchAccount?searchAccount:''}" class="page-link">Next</a></li>
                                            </c:if>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="insertasg" method="post">
                                        <input type="hidden" name="insert" value="insertAccount"/>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group" style="display: flex; gap: 10px">
                                                <div style="flex: 0.5;">
                                                    ...
                                                    <input type="text" name="role" value="Staff" class="form-control" readonly/>
                                                </div>

                                                <div style="flex: 0.5">
                                                    <label>Staff do not have account</label>
                                                    <select value="${staffID}" name="staffID" class="form-control">
                                                        <option>Choose</option>
                                                        <c:forEach var="notAcc" items="${liststaffNotAcc}">
                                                            <option value="${notAcc.staffID}" ${staffID==notAcc.staffID?'selected':''}>${notAcc.staffID}</option>
                                                        </c:forEach>
                                                    </select>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="updateasg" method="post">
                                        ...
                                        <div class="modal-header">
                                            <h4 class="modal-title">Edit Account Employee</h4>
                                            <button type="button" class="close" data-dismiss="modal" 
                                                    aria-hidden="true">&times;</button>
                                        </div>
                                        <div class="modal-body">
                                            <div style="width: 30%">
                                                ...
                                                <input value="${acc1.staff.staffID}" id="staffidAcc" readonly class="form-control" name="StaffID"/>
                                            </div>
                                            ...
                                            <div style="width: 30%">
                                                <label>Position</label>
                                                <select value="${role}" name="role" id="role" class="form-control">
                                                    <option>Choose</option>
                        ...
                        <!--Profile-->
                        <div id="profileEmployeeModal" class="modal fade">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="" method="">
                                        <input type="hidden" name="staffID" value="${acc1.staff.staffID}" id="staffID"/>
                                        <div class="modal-header">
                                            <h4 class="modal-title">Profile Employee</h4>
                                            <button type="button" class="close" data-dismiss="modal" 
                                                    aria-hidden="true">&times;</button>
                                        </div>
                                        <div class="modal-body">
                                            <div class="form-group" style="display: flex; gap: 10px">
                                                <div style="flex: 1;">
                                                    ...
                                                    <input type="text" value="" name="fname" id="fname" class="form-control" readonly>
                                                </div>
                                                <div style="flex: 1;">
                                                    <label>Last Name</label>
                                                    <input type="text" value="" name="lname" id="lname" class="form-control" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" id="hiredate" name="hiredate" class="form-control" readonly>
                                            </div>
                                        </div>
                                        <div class="modal-footer">
                                            <input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
                        ...
                        <div id="deleteEmployeeModal" class="modal fade">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="deleteaccountstaff" method="post">
                                        <input type="hidden" name="delete" value="deleteAccountStaff"/>
                                        <input type="hidden" name="AccountID" value="${acc1.accountID}" id=""/>
                                        <div class="modal-header">
        ...
        <script>
            ...
            $(document).ready(function () {
                ...
                $("#deleteStaffBtn").click(function () {
                    ...
                    if (staffIDs.length > 0) {
                        $.ajax({
                            type: "POST",
                            url: "deleteaccountstaff",
                            traditional: true,
                            data: {AccountID: staffIDs},
                            success: function () {
            ...
            $("#deleteStaffBtn").click(function () {
                if (staffIDToDelete) {
                    $.ajax({
                        type: "POST",
                        url: "deleteaccountstaff", // Servlet xử lý xóa
                        data: {AccountID: staffIDToDelete},
                        success: function () {
        ...
        <script>
            function staffFrom(id, user, pass, role, staffidAcc) {
                document.getElementById("AccountID").value = id;
                document.getElementById("username").value = user;
                document.getElementById("password").value = pass;
                document.getElementById("role").value = role;
                document.getElementById("staffidAcc").value = staffidAcc;
            }

            function staffFromProfile(id, fname, lname, position, salary, dob, add, city, country, phone, email, hiredate) {
