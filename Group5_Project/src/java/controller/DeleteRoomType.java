...
public class DeleteRoomType extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        new DAO.RoomTypeDAO().deleteByTypeID(typeID);
    ...
    throws ServletException, IOException {
        ...
        String deleteAll = request.getParameter("selectAll");
        if(deleteAll != null){
        ...
        for(int i =0 ;i<options.length; i++){
            int tmp = 0;
            try{
                tmp = Integer.parseInt(options[i]);
            }catch(NumberFormatException e){
                System.out.println(e);
            }
            if(tmp != 0){
                new DAO.RoomTypeDAO().deleteByTypeID(tmp);
            }
        }
