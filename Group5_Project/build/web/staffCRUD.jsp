                        ...
                        <div id="staffTable" class="col-md-12">
                            <div id="customertable" class="table-wrapper">
                                <div class="table-title">
                                    <div class="row">
                                        <div class="col-sm-6 p-0 d-flex justify-content-lg-start justify-content-center">
                                            <h2 class="ml-lg-2">Manage Staffs</h2>
                                                    ...
                                                    <ul class="dropdown-menu custom2-dropdown1">
                                                        <li class="nav-item submenu dropdown custom2-dropdown2">
                                                            ...
                                                            <ul class=" custom2-dropdown3">
                                                                <li class="nav-item">
                                                                    <a class="nav-link" href="staff?sortby=lastName&orderSort=asc&searchstaff=${not empty searchstaff?searchstaff:''}">Name</a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a class="nav-link" href="staff?sortby=dateOfBirth&orderSort=desc&searchstaff=${not empty searchstaff?searchstaff:''}">Age</a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a class="nav-link" href="staff?sortby=salary&orderSort=asc&searchstaff=${not empty searchstaff?searchstaff:''}">Salary</a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a class="nav-link" href="staff?sortby=hireDate&orderSort=asc&searchstaff=${not empty searchstaff?searchstaff:''}">Hire Date</a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                        <li class="nav-item submenu dropdown custom2-dropdown2">
                                                            ...
                                                            <ul class=" custom2-dropdown3">
                                                                <li class="nav-item">
                                                                    <a class="nav-link" href="staff?sortby=lastName&orderSort=desc&searchstaff=${not empty searchstaff?searchstaff:''}">Name</a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a class="nav-link" href="staff?sortby=dateOfBirth&orderSort=asc&searchstaff=${not empty searchstaff?searchstaff:''}">Age</a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a class="nav-link" href="staff?sortby=salary&orderSort=desc&searchstaff=${not empty searchstaff?searchstaff:''}">Salary</a>
                                                                </li>
                                                                <li class="nav-item">
                                                                    <a class="nav-link" href="staff?sortby=hireDate&orderSort=desc&searchstaff=${not empty searchstaff?searchstaff:''}">Hire Date</a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                    </ul>
                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody>
                                        <c:set var="studentIdSelected" value=""/>
                                        <c:forEach items="${listPage1}" var="sf" varStatus="status">
                                            <c:if test="${status.index == 0}">
                                                <c:set var="studentIdSelected" value="${sf.staffID}" />
                                            </c:if>
                                            <tr>
                                                <c:if test="${not empty sessionScope.acc && sessionScope.acc.role != null && sessionScope.acc.role == 'Admin'}">
                                                    <td>
                                                        <span class="custom-checkbox">
                                                            <input type="checkbox" class="select-item" id="checkbox1" name="options[]" value="${sf.staffID}"/>
                                                            <label for="checkbox1"></label>
                                                        </span>
                                                    </td>
                                                </c:if>
                                                <td style="white-space: nowrap;">${sf.staffID}</td>
                                                <td style="white-space: nowrap;">${sf.firstName}</td>
                                                <td style="white-space: nowrap;">${sf.lastName}</td>
                                                <td style="white-space: nowrap;">${sf.position}</td>
                                                <td style="white-space: nowrap;">${sf.salary}</td>
                                                <td style="white-space: nowrap;">${sf.dateOfBirth}</td>
                                                <td style="white-space: nowrap;">${sf.address}</td>
                                                <td style="white-space: nowrap;">${sf.city}</td>
                                                <td style="white-space: nowrap;">${sf.country}</td>
                                                <td>${sf.phone}</td>
                                                <td>${sf.email}</td>
                                                ...
                                                <c:if test="${not empty sessionScope.acc && sessionScope.acc.role != null && sessionScope.acc.role == 'Admin'}">
                                                    <td>
                                                        <a href="#editEmployeeModal" class="edit" data-toggle="modal"
                                                           onclick="staffFrom('${sf.staffID}', '${sf.firstName}', '${sf.lastName}', '${sf.position}',
                                                                           '${sf.salary}', '${sf.dateOfBirth}', '${sf.address}',
                                                                           '${sf.city}', '${sf.country}', '${sf.phone}', '${sf.email}', '${sf.hireDate}'
                                                                           );
                                                                   return false;">
                                ...
                                <div class="clearfix">
                                    ...
                                    <ul class="pagination">
                                        <c:if test="${tag > 1}">
                                            <li class="page-item disabled"><a href="staff?sortby=${not empty sortby?sortby:'default'}&orderSort=${not empty orderSort?orderSort:'default'}&index=${tag - 1}&searchstaff=${not empty searchstaff?searchstaff:''}">Previous</a></li>
                                            </c:if>
                                            <c:forEach begin="1" end="${endPage}" var="i">
                                            <li class="page-item  ${tag == i?"active":""}"><a href="staff?sortby=${not empty sortby?sortby:'default'}&orderSort=${not empty orderSort?orderSort:'default'}&index=${i}&searchstaff=${not empty searchstaff?searchstaff:''}" class="page-link">${i}</a></li>
                                            </c:forEach>
                                            <c:if test="${tag < endPage}">
                                            <li class="page-item"><a href="staff?sortby=${not empty sortby?sortby:'default'}&orderSort=${not empty orderSort?orderSort:'default'}&index=${tag + 1}&searchstaff=${not empty searchstaff?searchstaff:''}" class="page-link">Next</a></li>
                                            </c:if>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="insertasg" method="post">
                                        <input type="hidden" name="insert" value="insertStaff"/>
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group" style="display: flex; gap: 10px">
                                                <div style="flex: 0.7;">
                                                    ...
                                                    <p id="staffidError" style="color: red;">${staffidError}</p>
                                                </div>
                                            ...
                                            <div class="form-group" style="display: flex; gap: 10px">
                                                <div style="flex: 1;">
                                                    ...
                                                    <select value="${position}" name="position" class="form-control">
                                                        <option>Choose</option>
                                                        <option value="Manager" ${position=='Manager'?'selected':''}>Manager</option>
                                                        <option value="Housekeeping" ${position=='Housekeeping'?'selected':''}>Housekeeping</option>
                                                        <option value="Chef" ${position=='Chef'?'selected':''}>Chef</option>
                                                        <option value="Cashier" ${position=='Cashier'?'selected':''}>Cashier</option>
                                                        <option value="Receptionist" ${position=='Receptionist'?'selected':''}>Receptionist</option>
                                                        <option value="Security" ${position=='Security'?'selected':''}>Security</option>
                                                        <option value="Human Resources" ${position=='Human Resources'?'selected':''}>Human Resources</option>
                                                        <option value="Engineering & Maintenance" ${position=='Engineering & Maintenance'?'selected':''}>Engineering & Maintenance</option>
                                                    </select>
                                                    <!--<input type="text" value="${position}" name="position" class="form-control" required>-->
                                                </div>
                                                <div style="flex: 1;">
                                                    <label>Salary</label>
                                                    <input type="text" value="${salary}" name="salary" class="form-control" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" value="${hiredate}" name="hiredate" class="form-control" required>
                                            </div>
                                        </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="updateasg" method="post">
                                        <input type="hidden" name="update" value="updateStaff"/>
                                        <input type="hidden" name="staffID" value="${sf.staffID}" id="staffID"/>
                                        <span id="studentDetailID">${sf.staffID}</span>
                                        <div class="modal-header">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group" style="display: flex; gap: 10px">
                                                <div style="flex: 1;">
                                                    <label>First Name</label>
                                                    <input type="text" value="" name="fname" id="fname" class="form-control" required>
                                                </div>
                                                <div style="flex: 1;">
                                                    <label>Last Name</label>
                                                    <input type="text" value="" name="lname" id="lname" class="form-control" required>
                                                </div>
                                            </div>
...
//            function checkError() {
////                            var errMsg = document.getElementById("staffidError").innerText.trim();
//                var phoneudError = document.getElementById("phoneudError")?.innerText.trim();
//                var emailudError = document.getElementById("emailudError")?.innerText.trim();
//                if (phoneudError) {
//                    errorMessages.push(phoneudError);
...
//            }
        ...
        <script>
            function staffFrom(id, fname, lname, position, salary, dob, add, city, country, phone, email, hiredate) {
                ...
                document.getElementById("studentDetailID").innerText = id;
            }
